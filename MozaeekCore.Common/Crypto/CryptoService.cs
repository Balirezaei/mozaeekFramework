...
namespace MozaeekCore.Common.Crypto
{
    public static class CryptoService
    {
        ...
        public static bool VerifyPassword(String input, byte[] inputSalt, byte[] inputHash)
        {
            byte[] computedHash = ComputeHash(input, inputSalt);
            return AreHashesEqual(computedHash, inputHash);
        }
